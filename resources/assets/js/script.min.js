 ...
 * Date :   2nd Feb 2016.
 */
$(document).ready(function(){$(".socialshare-icons a").socialShare();$("#open-aboutme").hover(function(){$("#about-me").addClass("max-opacity")});$("#open-skill-set").hover(function(){$("#skill-set").addClass("max-opacity");$("#about-me").addClass("max-opacity");$("#facts-details").removeClass("max-opacity");$("#follow-links").removeClass("max-opacity")});$("#open-facts").hover(function(){$("#facts-details").addClass("max-opacity");$("#about-me").addClass("max-opacity");$("#follow-links").removeClass("max-opacity");$("#skill-set").removeClass("max-opacity")});$("#open-follow-me").hover(function(){$("#follow-links").addClass("max-opacity");$("#about-me").addClass("max-opacity");$("#facts-details").removeClass("max-opacity");$("#skill-set").removeClass("max-opacity")});$("#bar-1").jqbar({label:"AEM",value:80,barColor:"#21ba82"});$("#bar-2").jqbar({label:"JAVA",value:99,barColor:"#21ba82"});$("#bar-3").jqbar({label:"HTML/CSS",value:85,barColor:"#21ba82"});$("#bar-4").jqbar({label:"JAVASCRIPT",value:75,barColor:"#21ba82"});$("#bars-content .content").css({opacity:"0",display:"none"});$("#bars-content .content:eq(0)").css("display","block").animate({opacity:1},1000);$(".jqbar:first").addClass("active");$(".jqbar").hover(function(){$(this).addClass("hover")},function(){$(this).removeClass("hover")});$(".jqbar").click(function(){$(".jqbar").removeClass("active");var a=$(this).addClass("active").attr("id").replace("bar","content");$("#bars-content .content").css({opacity:"0",display:"none"});$("#"+a).css("display","block").animate({opacity:1},1000)})});(function(a){a.fn.socialShare=function(){return this.each(function(){var c=a(this);if(c.attr("href")!=undefined&&c.attr("href")!=""){var b=c.attr("href");if(b.indexOf("www.codebrains.co.in")!=-1){b=b.replace("www.codebrains.co.in",document.location.href)}}c.attr("href",b)})}})(jQuery);(function(a){a.fn.extend({jqbar:function(b){var c=a.extend({animationSpeed:2000,barLength:200,orientation:"h",barWidth:15,barColor:"red",label:"&nbsp;",value:100},b);return this.each(function(){var g=0;var f=a(this);if(c.orientation=="h"){f.addClass("jqbar horizontal").append('<span class="bar-label"></span><span class="bar-level-wrapper"><span class="bar-level"></span></span><span class="bar-percent"></span>');var e=f.find(".bar-label").html(c.label);var h=f.find(".bar-level").attr("data-value",c.value);var j=f.find(".bar-level-wrapper");h.css({height:c.barWidth,width:0,backgroundColor:c.barColor});var i=f.find(".bar-percent");i.html("0")}else{f.addClass("jqbar vertical").append('<span class="bar-percent"></span><span class="bar-level-wrapper"><span class="bar-level"></span></span><span class="bar-label"></span>');var e=f.find(".bar-label").html(c.label);var h=f.find(".bar-level").attr("data-value",c.value);var j=f.find(".bar-level-wrapper");f.css("height",c.barLength);h.css({height:c.barLength,top:c.barLength,width:c.barWidth,backgroundColor:c.barColor});j.css({height:c.barLength,width:c.barWidth});var i=f.find(".bar-percent");i.html("0");g=parseInt(i.outerHeight());i.css({top:(c.barLength-g)+"px"})}d(h);function d(m){var n=parseInt(m.attr("data-value"));if(n>100){n=100;alert("max value cannot exceed 100 percent")}var k=c.barLength*n/100;if(c.orientation=="h"){m.animate({width:k},{duration:2000,step:function(o){var p=parseInt(o/c.barLength*100);if(isNaN(p)){p=0}f.find(".bar-percent").html(p+"%")}})}else{var l=c.barLength-c.barLength*n/100;m.animate({top:l},{duration:2000,step:function(o){var p=parseInt((c.barLength-parseInt(o))/c.barLength*100);if(isNaN(p)){p=0}f.find(".bar-percent").html(Math.abs(p)+"%")}});f.find(".bar-percent").animate({top:(l-g)},2000)}}})}})})(jQuery);