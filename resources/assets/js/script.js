 ...
 * Copyright 2016 Codebrains.co.in
 * www.Codebrains.co.in
 * All rights reserved
 *
 * Developer : Ankit Gubrani (ankit.gubrani90@gmail.com)
 * Date :   2nd Feb 2016.
 */
$(document).ready(function() {
    $('.socialshare-icons a').socialShare();

    $('#open-aboutme').hover(function() {
        $('#about-me').addClass('max-opacity');
    });
    $('#open-skill-set').hover(function(){
        $('#skill-set').addClass('max-opacity');
        $('#about-me').addClass('max-opacity');
        $('#facts-details').removeClass('max-opacity');
        $('#follow-links').removeClass('max-opacity');
    });
    $('#open-facts').hover(function(){
        $('#facts-details').addClass('max-opacity');
        $('#about-me').addClass('max-opacity');
        $('#follow-links').removeClass('max-opacity');
        $('#skill-set').removeClass('max-opacity');

    });
    $('#open-follow-me').hover(function(){
        $('#follow-links').addClass('max-opacity');
        $('#about-me').addClass('max-opacity');
        $('#facts-details').removeClass('max-opacity');
        $('#skill-set').removeClass('max-opacity');
    });

    $('#bar-1').jqbar({ label: 'AEM', value: 80, barColor: '#21ba82' });

    $('#bar-2').jqbar({ label: 'JAVA', value: 99, barColor: '#21ba82' });

    $('#bar-3').jqbar({ label: 'HTML/CSS', value: 85, barColor: '#21ba82' });

    $('#bar-4').jqbar({ label: 'JAVASCRIPT', value: 75, barColor: '#21ba82' });
    ...
    $.fn.socialShare = function () {
        return this.each(function () {
            ...
            if(item.attr("href") != undefined && item.attr("href") != '') {
                ...
                if(href.indexOf('www.codebrains.co.in') != -1) {
                    href = href.replace('www.codebrains.co.in', document.location.href);
                }
            }
            item.attr("href", href);
        });
